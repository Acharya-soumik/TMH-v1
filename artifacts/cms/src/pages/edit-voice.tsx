...
import { Eye, Save, Send, Check, Upload, Archive, RotateCcw } from "lucide-react";
    ...
    <div className="max-w-3xl space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-3 gap-4">
          <Field label="Sector">
            <input type="text" value={form.sector} onChange={e => update("sector", e.target.value)} className="w-full px-3 py-2 bg-background border border-border rounded-md text-sm focus:outline-none focus:ring-1 focus:ring-primary" />
          </Field>
          <Field label="Country">
            <input type="text" value={form.country} onChange={e => update("country", e.target.value)} className="w-full px-3 py-2 bg-background border border-border rounded-md text-sm focus:outline-none focus:ring-1 focus:ring-primary" />
          </Field>
          <Field label="City">
            <input type="text" value={form.city} onChange={e => update("city", e.target.value)} className="w-full px-3 py-2 bg-background border border-border rounded-md text-sm focus:outline-none focus:ring-1 focus:ring-primary" />
          </Field>
        </div>
      ...
      {showPreview && <PreviewPanel type="voices" item={form} onClose={() => setShowPreview(false)} />}
    </div>
  );
}
