    ...
    >
      ...
      >
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-5 py-4 font-black uppercase tracking-[0.15em] text-[11px] transition-colors duration-150 rounded-sm bg-[#25D366]/10 border border-[#25D366]/30 text-[#25D366]"
        >
          ...
          <>
            ...
            {emailSubmitted ? (
              ...
              <form onSubmit={handleEmailSubmit} className="flex gap-2">
                ...
                <button
                  type="submit"
                  className="px-5 py-3 text-white font-black uppercase tracking-[0.1em] text-[11px] hover:opacity-90 transition-opacity whitespace-nowrap rounded-sm font-serif bg-primary"
                >
                  Unlock Results
                </button>
              </form>
