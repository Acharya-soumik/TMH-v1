...
export const PREDICTIONS_TICKER = [
  { label: "CINEMA SAUDI", yes: 50, delta: 0, up: true },
  { label: "$10B STARTUP", yes: 50, delta: 0, up: true },
  { label: "UAE INCOME TAX", yes: 50, delta: 0, up: true },
  { label: "ARABIC SCHOOLS", yes: 50, delta: 0, up: true },
  { label: "NEOM LINE", yes: 50, delta: 0, up: true },
  { label: "RIYADH METRO", yes: 50, delta: 0, up: true },
  { label: "SAUDI 2034 WC", yes: 50, delta: 0, up: true },
  { label: "EGYPT CAPITAL", yes: 50, delta: 0, up: true },
  { label: "GREEN H2 OMAN", yes: 50, delta: 0, up: true },
  { label: "GCC VISA", yes: 50, delta: 0, up: true },
  { label: "MOROCCO 2030 WC", yes: 50, delta: 0, up: true },
  { label: "TANGER MED", yes: 50, delta: 0, up: true },
  { label: "ALGERIA BORDER", yes: 50, delta: 0, up: true },
  { label: "TUNISIA IMF", yes: 50, delta: 0, up: true },
  { label: "EGYPT 115M POP", yes: 50, delta: 0, up: true },
  { label: "JORDAN WATER", yes: 50, delta: 0, up: true },
  { label: "LEBANON BANKS", yes: 50, delta: 0, up: true },
  { label: "IRAQ GRAND FAW", yes: 50, delta: 0, up: true },
  { label: "KUWAIT DEBT LAW", yes: 50, delta: 0, up: true },
  { label: "BAHRAIN FINTECH", yes: 50, delta: 0, up: true },
  { label: "QATAR LNG 126MT", yes: 50, delta: 0, up: true },
  { label: "TURKEY INFLATION", yes: 50, delta: 0, up: true },
  { label: "LIBYA ELECTION", yes: 50, delta: 0, up: true },
  { label: "SUDAN WAR", yes: 50, delta: 0, up: true },
  { label: "SYRIA SANCTIONS", yes: 50, delta: 0, up: true },
  { label: "PALESTINE 160 UN", yes: 50, delta: 0, up: true },
  { label: "YEMEN CRISIS", yes: 50, delta: 0, up: true },
  { label: "MOROCCO SOLAR", yes: 50, delta: 0, up: true },
  { label: "TURKEY DRONES", yes: 50, delta: 0, up: true },
  { label: "BAYKAR TB3", yes: 50, delta: 0, up: true },
]
